...
public class URLConnectionHTTPConduit extends HTTPConduit {
    ...
    protected OutputStream createOutputStream(Message message,
        ...
        try {
            return new URLConnectionWrappedOutputStream(message, connection, needToCacheRequest, isChunking, chunkThreshold, getConduitName());
    ...
    class URLConnectionWrappedOutputStream extends WrappedOutputStream {
        ...
        URLConnectionWrappedOutputStream(Message message, HttpURLConnection connection,
            ...
            super(message, needToCacheRequest, isChunking, chunkThreshold, conduitName, computeURI(message, connection));
